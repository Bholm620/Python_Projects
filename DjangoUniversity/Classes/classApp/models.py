...
class UniversityClasses(models.Model):
    ...
    year = models.FloatField(null=True, blank=True, default=None)
    ...
    def __str__(self):
        #Returns the input value of the title anf instructor name
        # field as a tuple to display in the browser instead of the default titles
        display_course = '{0.title}: {0.instructor_name}'
        return display_course.format(self)

    #Removes added 's' that django adds to the model name n the browser display
    class Meta:
